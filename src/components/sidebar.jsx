...
const Sidebar = () => {
  ...
  const ActiveSideNav = ({isActive}) => isActive ? 'cursor-pointer block pathNavIcon bg-green-primary px-10 text-white' : 'block hover:bg-gray-100 cursor-pointer px-10'
  ...
  return (
    <div className="hidden md:flex flex-1 border-r-[1px] border-gray-100 h-screen flex-col align-middle justify-between">
      ...
      <div className="flex-col space-y-4 mb-20">
        ...
        <NavLink to={'/activity'} className={ ActiveSideNav }>
          <div className="flex align-middle p-4">
            <ActivityIcon color={"#200E32"} colorTwo={"#C0CCDA"} />
            <div className="ps-5 my-auto">Activity</div>
          </div>
        </NavLink>
        <NavLink to={'/products'} className={ ActiveSideNav }>
          <div className="flex align-middle p-4">
            <FaCube color={"#C0CCDA"} size={"33"} />
            <div className="ps-5 my-auto">Products</div>
          </div>
        </NavLink>
        <NavLink to={'/settings'} className={ ActiveSideNav }>
          <div className="flex align-middle p-4">
            <IoMdSettings color={"#C0CCDA"} fill="#C0CCDA" size={"35"} />
