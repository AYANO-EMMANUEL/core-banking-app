    ...
    return (
      ...
      >
        <path
          ...
          fill={color}  className="pathNavIcon2"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill={colorTwo} className="pathNavIcon1"
        />
      </svg>
    );
  };
    ...
    return (
      ...
      >
        <path
          ...
          fill={colorTwo} className="pathNavIcon1"
        />
        <circle cx="17.5" cy="2.5" r="2.5" fill={color} className="pathNavIcon2"/>
      </svg>
    );
  };
  const ActiveBottomNav = ({ isActive }) => isActive ? " cursor-pointer block pathNavIcon bg-green-primary rounded-xl text-white " : "cursor-pointer block hover:bg-gray-100 rounded-xl";


  return (
    <div className="md:hidden sticky bottom-0 left-0 bg-white flex items-center justify-around py-2 shadow-md z-[10000000] drop-shadow-lg">
      <NavLink to={'/app'} className={ActiveBottomNav}>
        <div className="flex flex-col items-center align-middle p-4">
          <DashboardIcon color={"#200E32"} colorTwo={"#C0CCDA"}/>
        </div>
      </NavLink>
      <NavLink to={'/activity'} className={ActiveBottomNav}>
        <div className="flex flex-col items-center align-middle p-4">
        <ActivityIcon color={"#200E32"} colorTwo={"#C0CCDA"}/>
        </div>
      </NavLink>
      <NavLink to={'/products'} className={ActiveBottomNav}>
        <div className="flex flex-col items-center align-middle p-4">
          <FaCube color={"#C0CCDA"} size={"35"}/>
        </div>
      </NavLink>
      <NavLink to={'/settings'} className={ActiveBottomNav}>
        <div className="flex flex-col items-center align-middle p-4">
          <IoMdSettings  fill="#C0CCDA" size={"35"}/>
        </div>
      </NavLink>
    </div>
  );
